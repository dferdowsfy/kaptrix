...
SCORING SOURCE OF TRUTH (HARD OVERRIDE).
- The user prompt may include a "SCORING SOURCE OF TRUTH" block carrying the platform's locked scoring decision: recommendation, risk_posture, confidence_score, composite_score, dimension_scores, scoring_timestamp, scoring_version.
