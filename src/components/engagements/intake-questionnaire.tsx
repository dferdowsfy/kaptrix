...
const CORE_INTAKE_QUESTIONS: IntakeQuestion[] = [
  ...
  // Phase 1 — first intake section. Answers feed the deterministic
  // Commercial Pain Confidence score (0–100, separate from the AI
  // Diligence Score) and surface as intake_claim KB chunks that the
  // report layer must NOT treat as artifact-backed evidence.
  // Section ordering is array-position-based (see line 1135) — keep
  // this block first so "Commercial Pain Validation" is the first tab.
  // Every field is a single or multi select — no free-form. Free-form
  // text was making the deterministic score and the LLM-rendered reports
  // unreliable: typed answers can't be mapped to the scoring enums and
  // the report layer drifts. Each question carries the minimum number
  // of mutually-exclusive options needed to capture meaningful variance.
  {
    id: "problem_statement",
    section: "Commercial Pain Validation",
    prompt: "Primary problem domain the product addresses",
    help: "Pick the single closest fit. Use 'Other / cross-domain' only if no domain dominates.",
    type: "single",
    options: [
  ...
  },
  {
    id: "buyer_persona",
    section: "Commercial Pain Validation",
    prompt: "Primary buyer role at the customer",
    type: "single",
    options: [
  ...
  {
    id: "buyer_persona_notes",
    section: "Commercial Pain Validation",
    prompt: "Buyer company size",
    type: "single",
    options: [
      "Fortune 500 / large enterprise",
      "Upper mid-market ($500M–$2B)",
      "Mid-market ($50M–$500M)",
      "SMB (<$50M)",
      "Startup",
      "Mixed / unknown",
  ...
  },
  {
    id: "pain_severity",
    section: "Commercial Pain Validation",
    prompt: "How severe is the pain for the buyer?",
    type: "single",
    options: [
      "Mission-critical",
      "High",
  ...
  },
  {
    id: "pain_frequency",
    section: "Commercial Pain Validation",
    prompt: "How often does the buyer experience this pain?",
    type: "single",
    options: [
      "Daily or continuous",
      "Weekly",
  ...
  {
    id: "cost_of_pain_categories",
    section: "Commercial Pain Validation",
    prompt: "How does the pain show up as cost? (select all that apply)",
    type: "multi",
    options: [
      "Lost revenue",
      "Churn risk",
      "Operating cost / FTE drag",
      "Compliance exposure",
  ...
  {
    id: "cost_of_pain_notes",
    section: "Commercial Pain Validation",
    prompt: "Estimated annual cost per buyer",
    help: "Order-of-magnitude bucket. Source and confidence are tracked separately downstream.",
    type: "single",
    options: [
      "<$10k",
      "$10k–$100k",
  ...
  },
  {
    ...
    section: "Commercial Pain Validation",
    prompt: "What buyers use today (select all that apply)",
    type: "multi",
    options: [
      "Manual workflow / human labor",
      "Spreadsheets / ad-hoc tools",
      "In-house build / custom code",
      "Named SaaS competitor",
      "Open-source / DIY",
  ...
  {
    id: "current_alternative_notes",
    section: "Commercial Pain Validation",
    prompt: "Switching cost from current alternative",
    type: "single",
    options: [
      "Trivial (days, no contract)",
      "Moderate (weeks, light integration)",
      "High (months, deep integration)",
      "Severe (>12 months or contract lock-in)",
      "Unknown",
    ],
  },
  {
    id: "status_quo_failure",
    section: "Commercial Pain Validation",
    prompt: "How does the status quo fail? (select all that apply)",
    type: "multi",
    options: [
      "Too slow / cycle time too long",
      "Too inaccurate / error-prone",
  ...
  {
    id: "status_quo_failure_notes",
    section: "Commercial Pain Validation",
    prompt: "Status-quo pain acuity for the buyer",
    type: "single",
    options: [
      "Actively shopping for a replacement",
      "Has budget allocated, evaluating",
      "Frustrated but not yet shopping",
      "Tolerates the pain",
      "Unknown",
    ],
  },
  {
    id: "customer_demand_evidence",
    section: "Commercial Pain Validation",
    prompt: "Evidence of customer demand today (select all that apply)",
    help: "The strongest tier present drives the score. Founder claims only is the weakest.",
    type: "multi",
    options: [
      "Paying customers",
      "Signed contracts",
  ...
  {
    id: "customer_demand_evidence_notes",
    section: "Commercial Pain Validation",
    prompt: "Number of named paying customers",
    type: "single",
    options: [
      "0",
      "1–3",
  ...
  },
  {
    id: "solution_fit",
    section: "Commercial Pain Validation",
    prompt: "How well does the product solve the stated pain?",
    type: "single",
    options: [
      "Directly solves the core pain",
      "Solves a major part of the pain",
      "Solves a narrow part of the pain",
      "Adjacent to the pain but not central",
      "Unclear connection between product and pain",
      "Product does not clearly solve the stated pain",
    ],
  },
  {
    id: "ai_necessity",
    section: "Commercial Pain Validation",
    prompt: "Is AI necessary to solve this pain?",
    help: "If non-AI alternatives could deliver the outcome, AI necessity is weaker.",
    type: "single",
    options: [
      "Yes — AI is necessary",
  ...
  {
    id: "ai_necessity_notes",
    section: "Commercial Pain Validation",
    prompt: "Viable non-AI alternatives (select all that apply)",
    type: "multi",
    options: [
      "Rule-based / deterministic system",
      "Classical ML (no LLM)",
  ...
  },
  {
    id: "promised_outcome",
    section: "Commercial Pain Validation",
    prompt: "Type of outcome the company promises (select all that apply)",
    type: "multi",
    options: [
      "Time / cycle reduction",
      "Cost reduction",
      "Accuracy / quality lift",
  ...
  {
    id: "promised_outcome_notes",
    section: "Commercial Pain Validation",
    prompt: "Magnitude of the promised outcome",
    type: "single",
    options: [
      "≥10x baseline",
      "2–10x baseline",
  ...
  },
  {
    id: "outcome_proof",
    section: "Commercial Pain Validation",
    prompt: "How well is the promised outcome proven today?",
    type: "single",
    options: [
  ...
  {
    id: "outcome_proof_notes",
    section: "Commercial Pain Validation",
    prompt: "Forms of proof present (select all that apply)",
    type: "multi",
    options: [
  ...
  },
  {
    id: "buying_trigger",
    section: "Commercial Pain Validation",
    prompt: "Primary event that triggers the buyer to act",
    type: "single",
    options: [
      "Regulatory deadline / mandate",
      "Audit failure / finding",
      "Competitive loss / pressure",
      "Annual budget cycle",
      "Executive / board mandate",
      "Cost-cutting or margin pressure",
      "Incident / breach / SLA miss",
      "No clear trigger",
    ],
  },
  {
    id: "buying_trigger_notes",
    section: "Commercial Pain Validation",
    prompt: "How often does this trigger occur in the target market?",
    type: "single",
    options: [
      "Recurring (annually or more often)",
      "Occasional (every 2–3 years)",
      "Rare / one-time",
      "Speculative / not yet observed",
      "Unknown",
    ],
  },
  {
    id: "buying_urgency",
    section: "Commercial Pain Validation",
    prompt: "How urgent is the buying decision?",
    type: "single",
    options: [
      "Immediate",
      "Near-term",
  ...
  {
    id: "missing_pain_evidence",
    section: "Commercial Pain Validation",
    prompt: "Commercial validation evidence still missing (select all that apply)",
    type: "multi",
    options: [
      ...
      "Renewal / expansion data",
      "Win/loss analysis",
      "Independent benchmarks / audits",
      "None — fully evidenced",
    ],
  },
  {
    id: "missing_pain_evidence_notes",
    section: "Commercial Pain Validation",
    prompt: "How obtainable is the missing evidence pre-close?",
    type: "single",
    options: [
      "Likely obtainable in <30 days",
      "Likely obtainable in 30–90 days",
      "Requires post-close access",
      "Likely unobtainable",
