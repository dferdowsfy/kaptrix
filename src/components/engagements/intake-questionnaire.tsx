...
const CORE_INTAKE_QUESTIONS: IntakeQuestion[] = [
  ...
  },
  {
    ...
    help: "Shapes tone and which evidence is foregrounded — PE audiences want returns-and-risks framing, corporate ICs want program-health framing.",
    type: "single",
    options: [
      "Large-cap PE fund",
      "Growth equity fund",
  ...
  },
  {
    ...
    help: "Pick the bucket closest to current ARR (or total initiative budget if pre-revenue). Sets the scale-of-stakes framing in the report.",
    type: "single",
    options: [
      "<$10M",
      "$10M – $50M",
  ...
  },
  {
    ...
    help: "Be honest — it compresses or relaxes the depth of the diligence. Pick the closest bucket or type an exact number under Other.",
    type: "single",
    options: [
      "<= 7 days",
      "8 - 14 days",
  ...
  },
  {
    ...
    help: "Later-stage decisions get harder recommendations; earlier stages get more exploratory framing.",
    type: "single",
    options: [
  ...
  },
  {
    ...
    help: "Helps the report pre-answer the objections you know are coming from specific seats at the table.",
    type: "multi",
    options: [
      "Security / CISO",
      "Legal / compliance",
  ...
  // ────────────────── Budget & Unit Economics ──────────────────
  {
    ...
    help: "Equity check size, initiative budget, or multi-year contract TCV. Pick the closest bucket or type a precise number under Other.",
    type: "single",
    options: [
      "< $100K",
      "$100K - $1M",
  ...
  },
  {
    ...
    help: "Inference, vendor fees, infra, data ops, and loaded people cost combined. Pick the closest bucket or type a precise figure under Other.",
    type: "single",
    options: [
      "< $50K",
      "$50K - $250K",
  ...
  },
  {
    ...
    help: "1 = willing to lose money for speed/share; 5 = every cost dollar scrutinized against margin targets.",
    type: "scale",
    scale_min: 1,
    scale_max: 5,
  ...
  },
  {
    ...
    help: "How quickly capital invested must come back — drives whether the report emphasizes payback math or strategic value.",
    type: "single",
    options: [
      "< 6 months",
      "6 - 12 months",
      ...
      "24 - 36 months",
      "36+ months",
      "Strategic — payback not required",
      "Unknown",
    ],
  },
  {
  ...
  // ────────────────── Alternatives & Incumbents ──────────────────
  {
    ...
    help: "The report will explicitly contrast the target against these alternatives in the recommendation.",
    type: "multi",
    options: [
      "Build in-house",
  ...
  },
  {
    ...
    help: "e.g. 'Glean vs. Notion AI vs. internal Copilot build led by our platform team'. Specific names produce sharper comparisons.",
    type: "long_text",
  },
  {
    ...
    help: "1 = trivial replacement; 5 = multi-year migration with regulator or customer contract impact.",
    type: "scale",
    scale_min: 1,
    scale_max: 5,
  ...
  },
  {
    ...
    help: "Determines how hard the report pushes on exit plans, escrow, open standards, and portability.",
    type: "single",
    options: [
  ...
  // ────────────────── Internal AI Readiness ──────────────────
  {
    ...
    help: "1 = no ML staff; 5 = platform team with MLOps, evaluation harnesses, and production models today.",
    type: "scale",
    scale_min: 1,
    scale_max: 5,
  ...
  },
  {
    ...
    help: "How easily the organization can actually feed AI systems — the biggest hidden blocker on most programs.",
    type: "single",
    options: [
  ...
  },
  {
    ...
    help: "What's already live. Influences integration-risk and change-management analysis.",
    type: "multi",
    options: [
  ...
  // ────────────────── Target / Vendor Profile ──────────────────
  {
    ...
    help: "1 = classic software with an AI marketing skin; 5 = product whose value disappears without the model.",
    type: "scale",
    scale_min: 1,
    scale_max: 5,
  ...
  },
  {
    ...
    help: "Your best read from demos, docs, or press. Drives which risk patterns the report pressure-tests first.",
    type: "single",
    options: [
      "RAG-heavy",
      "Fine-tuned models",
  ...
  // ────────────────── Regulatory Lens ──────────────────
  {
    ...
    help: "Every framework selected becomes a required coverage area in the report.",
    type: "multi",
    options: [
      "GDPR / UK GDPR",
      "CCPA / CPRA",
  ...
  },
  {
    ...
    help: "Drives residency, transfer-mechanism, and cross-border consent analysis.",
    type: "multi",
    options: [
      "United States",
      "European Union",
  ...
  // ────────────────── Data Rights & IP Posture ──────────────────
  {
    ...
    help: "Unknown / undocumented is itself a finding. Select all sources the target plausibly uses.",
    type: "multi",
    options: [
  ...
  },
  {
    ...
    help: "How the target contracts its right to use customer data in models — a top-three source of legal surprises.",
    type: "single",
    options: [
  ...
  },
  {
    ...
    help: "How hard you need the vendor to stand behind IP and training-data claims against the output.",
    type: "single",
    options: [
  ...
  // ────────────────── Operational Resilience ──────────────────
  {
    ...
    help: "Worst-case downtime the business can absorb before material damage — drives SLA and failover analysis.",
    type: "single",
    options: [
  ...
  },
  {
    ...
    help: "1 = no plan; 5 = documented, rehearsed, with exported-format and re-ingest tooling proven.",
    type: "scale",
    scale_min: 1,
    scale_max: 5,
  ...
  },
  {
    ...
    help: "Where data physically has to live. Select all that are contractually or regulatorily required.",
    type: "single",
    options: [
  ...
  },
  {
    ...
    help: "1 = institutional conservatism; 5 = comfortable being first-mover on unproven AI patterns.",
    type: "scale",
    scale_min: 1,
    scale_max: 5,
  ...
  },
  {
    ...
    help: "Who will consume the report. Drives depth calibration per audience.",
    type: "multi",
    options: [
...
const INDUSTRY_INTAKE_QUESTIONS: Record<Industry, IntakeQuestion[]> = {
  financial_services: [
    ...
    },
    {
      ...
      help: "1 = black-box outputs; 5 = adverse-action-ready reasons, reproducible, defensible to a regulator.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
    ...
    },
    {
      ...
      help: "Which audit control universes the AI system touches. Drives scoping of SOX, SR 11-7, and fair-lending analysis.",
      type: "multi",
      options: [
        "SOX controls",
  ...
  healthcare: [
    {
      ...
      help: "PHI in prompts or logs is the single biggest silent HIPAA landmine in AI systems.",
      type: "single",
      options: [
    ...
    },
    {
      ...
      help: "1 = no classification work done; 5 = clear SaMD pathway with pre-sub or 510(k) in motion.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
    ...
    },
    {
      ...
      help: "Formal controls only — policy statements without evidence don't count here.",
      type: "multi",
      options: [
  ...
  legal_tech: [
    ...
    },
    {
      ...
      help: "1 = hallucinated citations possible; 5 = every citation verified against a closed corpus before display.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
    ...
    },
    {
      ...
      help: "Areas where bar authorities have flagged AI use — the report elevates any that are live risks.",
      type: "multi",
      options: [
  ...
  saas_enterprise: [
    {
      ...
      help: "1 = missing core enterprise features (SSO/SCIM/audit); 5 = enterprise-complete and independently verified.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
    ...
    },
    {
      ...
      help: "How users or attackers can misuse the AI surface. 'No formal abuse model' is itself a finding.",
      type: "multi",
      options: [
    ...
    },
    {
      ...
      help: "Model cost volatility is the top reason AI SaaS margins surprise investors.",
      type: "single",
      options: [
  ...
  insurance: [
    {
      ...
      help: "1 = no subgroup analysis; 5 = documented fairness thresholds with continuous monitoring and remediation.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
    ...
    },
    {
      ...
      help: "Reason-code readiness for denials — drives FCRA/ECOA and state DOI analysis.",
      type: "single",
      options: [
        "Not implemented",
    ...
    },
    {
      ...
      help: "Which AI-specific insurance guidance the target has actually mapped to.",
      type: "multi",
      options: [
  ...
  retail_ecommerce: [
    {
      ...
      help: "How the target proves AI-generated marketing claims aren't deceptive — FTC exposure lives here.",
      type: "single",
      options: [
    ...
    },
    {
      ...
      help: "Ways personalization can cross a legal or reputational line.",
      type: "multi",
      options: [
        "Dark pattern risk",
    ...
    },
    {
      ...
      help: "1 = weak and undocumented; 5 = published policy + controls + monitoring + breach-response plan.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
  ...
  government_defense: [
    {
      ...
      help: "Where the target sits on the FedRAMP or DoD IL ladder today — gates most federal revenue.",
      type: "single",
      options: [
        "No plan",
        "Roadmap only",
    ...
    },
    {
      ...
      help: "Controls around regulated technical data and controlled unclassified information.",
      type: "multi",
      options: [
        "ITAR controls",
    ...
    },
    {
      ...
      help: "1 = no SBOM or provenance story; 5 = continuous SBOM, signed artifacts, and attestation.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
  ...
  industrial_iot: [
    {
      ...
      help: "1 = flat network between IT and OT; 5 = strongly segmented with monitored boundary controls.",
      type: "scale",
      scale_min: 1,
      scale_max: 5,
    ...
    },
    {
      ...
      help: "How confidently the system stays inside its safety envelope — validated means someone actually tested it.",
      type: "single",
      options: [
        "Not measured",
    ...
    },
    {
      ...
      help: "Legacy OT surface that attackers exploit. 'Low material exposure' means audited and confirmed, not assumed.",
      type: "multi",
      options: [
