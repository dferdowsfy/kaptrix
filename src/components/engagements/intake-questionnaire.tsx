...
const CORE_INTAKE_QUESTIONS: IntakeQuestion[] = [
  ...
  // this block first so "Commercial Pain Validation" is the first tab.
  {
    ...
    prompt: "What is the primary problem this company solves?",
    help: "One or two sentences. Focus on the buyer's pain, not the product features.",
    type: "long_text",
  },
  {
    id: "buyer_persona",
    section: "Commercial Pain Validation",
    prompt: "Who is the primary buyer of this product?",
    help: "Role + function + seniority (e.g. 'mid-market PE associates and VPs').",
    type: "short_text",
  },
  {
    id: "buyer_persona_notes",
    section: "Commercial Pain Validation",
    prompt: "Buyer persona — additional notes",
    help: "Industry, segment, geography, deal-size context.",
    type: "long_text",
  },
  {
    id: "pain_severity",
  ...
  },
  {
    ...
    section: "Commercial Pain Validation",
    prompt: "Quantify the cost of pain",
    help: "Dollars / hours / FTEs / churn% per buyer where possible. Cite the source.",
    type: "long_text",
  },
  {
    id: "current_alternative",
    section: "Commercial Pain Validation",
    prompt: "What are buyers using today instead of this product?",
    help: "Manual workflow, spreadsheet, named competitor, in-house build, nothing.",
    type: "short_text",
  },
  {
    id: "current_alternative_notes",
    section: "Commercial Pain Validation",
    prompt: "Current alternative — additional notes",
    type: "long_text",
  },
  {
    id: "status_quo_failure",
    section: "Commercial Pain Validation",
    prompt: "Why does the status quo fail to solve the pain?",
    help: "Specific failure modes — slow, inaccurate, expensive, unscalable, non-compliant.",
    type: "long_text",
  },
  {
    id: "status_quo_failure_notes",
    section: "Commercial Pain Validation",
    prompt: "Status quo failure — additional notes",
    type: "long_text",
  },
  {
    id: "customer_demand_evidence",
    section: "Commercial Pain Validation",
    prompt: "What evidence of customer demand exists today? (select all that apply)",
  ...
  },
  {
    ...
    section: "Commercial Pain Validation",
    prompt: "Demand evidence — additional notes",
    help: "Name specific logos, contract values, retention metrics, or interview sources.",
    type: "long_text",
  },
  {
    id: "solution_fit",
  ...
  },
  {
    ...
    section: "Commercial Pain Validation",
    prompt: "AI necessity — supporting notes",
    help: "Name non-AI alternatives and where they fall short.",
    type: "long_text",
  },
  {
    id: "promised_outcome",
    section: "Commercial Pain Validation",
    prompt: "What measurable outcome does the company promise its buyers?",
    help: "Cycle-time cut, accuracy lift, $ saved, % conversion lift — be specific.",
    type: "long_text",
  },
  {
    id: "promised_outcome_notes",
    section: "Commercial Pain Validation",
    prompt: "Promised outcome — additional notes",
    type: "long_text",
  },
  {
    id: "outcome_proof",
  ...
  },
  {
    ...
    section: "Commercial Pain Validation",
    prompt: "Outcome proof — cite the specific evidence",
    help: "Filenames, sections, named customers, dashboard URLs.",
    type: "long_text",
  },
  {
    id: "buying_trigger",
    section: "Commercial Pain Validation",
    prompt: "What event triggers a buyer to act?",
    help: "Regulatory deadline, budget cycle, exec mandate, audit failure, growth target.",
    type: "short_text",
  },
  {
    id: "buying_trigger_notes",
    section: "Commercial Pain Validation",
    prompt: "Buying trigger — additional notes",
    type: "long_text",
  },
  {
    id: "buying_urgency",
  ...
  },
  {
    ...
    section: "Commercial Pain Validation",
    prompt: "What commercial validation evidence is still missing?",
    help: "Anything you would need to see (artifacts, customer calls, dashboards) before relying on the answers above for IC.",
    type: "long_text",
  },
  {
    id: "missing_pain_evidence_notes",
    section: "Commercial Pain Validation",
    prompt: "Missing evidence — additional notes",
    type: "long_text",
  },
