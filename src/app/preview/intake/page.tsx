...
function buildIntakePayloadFromAnswers(
  ...
  const commercial_pain_validation = hasCommercialPainAnswers
    ? {
        ...
        current_alternative: asArray(answers["current_alternative"]),
        current_alternative_notes: asStr(answers["current_alternative_notes"]),
        status_quo_failure: asArray(answers["status_quo_failure"]),
        ...
        ai_necessity_notes: asArray(answers["ai_necessity_notes"]),
        promised_outcome: asArray(answers["promised_outcome"]),
        promised_outcome_notes: asStr(answers["promised_outcome_notes"]),
        outcome_proof: asStr(answers["outcome_proof"]),
        outcome_proof_notes: asArray(answers["outcome_proof_notes"]),
        ...
        missing_pain_evidence: asArray(answers["missing_pain_evidence"]),
