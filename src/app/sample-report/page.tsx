...
export const metadata = {
  title: "Sample Report — Master AI Diligence (Orbital Ops) | Kaptrix",
  description:
    "A sample Kaptrix Master AI Diligence Report for Orbital Ops (LexiFlow AI).",
};
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <article className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <section className="mt-12 space-y-4 text-[15px] leading-7 text-slate-700">
          ...
          <p>
            <strong>Decision:</strong> Require Orbital Ops to implement a
            ...
            adjust deal terms accordingly to reflect the reduced exit
            multiple risk.
          </p>
        </section>
        ...
        <div className="mt-12 flex justify-between border-t border-slate-200 pt-6 text-xs text-slate-500">
          <span>Master AI Diligence Report — Orbital Ops</span>
